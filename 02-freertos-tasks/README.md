...
The code runs straight from top to bottom, over and over. This works fine until you introduce something that takes time, like a delay. 
...
- control a `9g servo motor's` angle based on a potentiometer input.
